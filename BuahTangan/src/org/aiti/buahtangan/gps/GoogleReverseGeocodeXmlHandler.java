package org.aiti.buahtangan.gps;
...
public class GoogleReverseGeocodeXmlHandler extends DefaultHandler
{
    ...
    private boolean inAdvName = false;
    ...
    public void characters(char[] ch, int start, int length)
        ...
        if ((this.inLocalityName || this.inAdvName ) && !this.finished)
        {
            if ((ch[start] != '\n') && (ch[start] != ' '))
            {
