...
public class DaftarWisataGroup extends ActivityGroup {
	...
	// work properly, don't use this if your activities requires a lot of memory.
		...
		protected void onCreate(Bundle savedInstanceState) {
		      ...
		      View view = getLocalActivityManager().startActivity("DaftarWisata", new
		    	      							Intent(this,DaftarWisata.class)
